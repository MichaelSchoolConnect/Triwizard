...
public class HousesInfoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        housesViewHolder.value_0.setText(housesInfo.values_0);
        housesViewHolder.value_1.setText(housesInfo.values_1);
        housesViewHolder.value_2.setText(housesInfo.values_2);
        housesViewHolder.value_3.setText(housesInfo.values_3);
    }
